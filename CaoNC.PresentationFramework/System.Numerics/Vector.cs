...
namespace CaoNC.System.Numerics
{
    ...
    public struct Vector<T> : IEquatable<Vector<T>>, IFormattable where T : struct
    {
        ...
        public unsafe Vector(T[] values, int index)
        {
            ...
            {
                throw new IndexOutOfRangeException(SR.Format(SR.Arg_InsufficientNumberOfElements, Count, "values"));
            }
            if (Vector.IsHardwareAccelerated)
            {
                if (typeof(T) == typeof(byte))
        ...
        public override int GetHashCode()
        {
            ...
            if (Vector.IsHardwareAccelerated)
            {
                if (typeof(T) == typeof(byte))
                {
                    for (int i = 0; i < Count; i++)
                    {
                        num = CaoNC.System.Numerics.HashHelpers.Combine(num, ((byte)(object)this[i]).GetHashCode());
                    }
                    return num;
                }
                if (typeof(T) == typeof(sbyte))
                {
                    for (int j = 0; j < Count; j++)
                    {
                        num = CaoNC.System.Numerics.HashHelpers.Combine(num, ((sbyte)(object)this[j]).GetHashCode());
                    }
                    return num;
                }
                if (typeof(T) == typeof(ushort))
                {
                    for (int k = 0; k < Count; k++)
                    {
                        num = CaoNC.System.Numerics.HashHelpers.Combine(num, ((ushort)(object)this[k]).GetHashCode());
                    }
                    return num;
                }
                if (typeof(T) == typeof(short))
                {
                    for (int l = 0; l < Count; l++)
                    {
                        num = CaoNC.System.Numerics.HashHelpers.Combine(num, ((short)(object)this[l]).GetHashCode());
                    }
                    return num;
                }
                if (typeof(T) == typeof(uint))
                {
                    for (int m = 0; m < Count; m++)
                    {
                        num = CaoNC.System.Numerics.HashHelpers.Combine(num, ((uint)(object)this[m]).GetHashCode());
                    }
                    return num;
                }
                if (typeof(T) == typeof(int))
                {
                    for (int n = 0; n < Count; n++)
                    {
                        num = CaoNC.System.Numerics.HashHelpers.Combine(num, ((int)(object)this[n]).GetHashCode());
                    }
                    return num;
                }
                if (typeof(T) == typeof(ulong))
                {
                    for (int num2 = 0; num2 < Count; num2++)
                    {
                        num = CaoNC.System.Numerics.HashHelpers.Combine(num, ((ulong)(object)this[num2]).GetHashCode());
                    }
                    return num;
                }
                if (typeof(T) == typeof(long))
                {
                    for (int num3 = 0; num3 < Count; num3++)
                    {
                        num = CaoNC.System.Numerics.HashHelpers.Combine(num, ((long)(object)this[num3]).GetHashCode());
                    }
                    return num;
                }
                if (typeof(T) == typeof(float))
                {
                    for (int num4 = 0; num4 < Count; num4++)
                    {
                        num = CaoNC.System.Numerics.HashHelpers.Combine(num, ((float)(object)this[num4]).GetHashCode());
                    }
                    return num;
                }
                if (typeof(T) == typeof(double))
                {
                    ...
                    {
                        num = CaoNC.System.Numerics.HashHelpers.Combine(num, ((double)(object)this[num5]).GetHashCode());
                    }
                    return num;
                }
                throw new NotSupportedException(SR.Arg_TypeNotSupported);
            ...
            if (typeof(T) == typeof(byte))
            {
                num = CaoNC.System.Numerics.HashHelpers.Combine(num, register.byte_0.GetHashCode());
                num = CaoNC.System.Numerics.HashHelpers.Combine(num, register.byte_1.GetHashCode());
                num = CaoNC.System.Numerics.HashHelpers.Combine(num, register.byte_2.GetHashCode());
                num = CaoNC.System.Numerics.HashHelpers.Combine(num, register.byte_3.GetHashCode());
                num = CaoNC.System.Numerics.HashHelpers.Combine(num, register.byte_4.GetHashCode());
                num = CaoNC.System.Numerics.HashHelpers.Combine(num, register.byte_5.GetHashCode());
                num = CaoNC.System.Numerics.HashHelpers.Combine(num, register.byte_6.GetHashCode());
                num = CaoNC.System.Numerics.HashHelpers.Combine(num, register.byte_7.GetHashCode());
                num = CaoNC.System.Numerics.HashHelpers.Combine(num, register.byte_8.GetHashCode());
                num = CaoNC.System.Numerics.HashHelpers.Combine(num, register.byte_9.GetHashCode());
                num = CaoNC.System.Numerics.HashHelpers.Combine(num, register.byte_10.GetHashCode());
                num = CaoNC.System.Numerics.HashHelpers.Combine(num, register.byte_11.GetHashCode());
                num = CaoNC.System.Numerics.HashHelpers.Combine(num, register.byte_12.GetHashCode());
                num = CaoNC.System.Numerics.HashHelpers.Combine(num, register.byte_13.GetHashCode());
                num = CaoNC.System.Numerics.HashHelpers.Combine(num, register.byte_14.GetHashCode());
                return CaoNC.System.Numerics.HashHelpers.Combine(num, register.byte_15.GetHashCode());
            }
            if (typeof(T) == typeof(sbyte))
            {
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.sbyte_0.GetHashCode());
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.sbyte_1.GetHashCode());
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.sbyte_2.GetHashCode());
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.sbyte_3.GetHashCode());
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.sbyte_4.GetHashCode());
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.sbyte_5.GetHashCode());
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.sbyte_6.GetHashCode());
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.sbyte_7.GetHashCode());
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.sbyte_8.GetHashCode());
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.sbyte_9.GetHashCode());
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.sbyte_10.GetHashCode());
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.sbyte_11.GetHashCode());
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.sbyte_12.GetHashCode());
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.sbyte_13.GetHashCode());
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.sbyte_14.GetHashCode());
                return  CaoNC.System.Numerics.HashHelpers.Combine(num, register.sbyte_15.GetHashCode());
            }
            if (typeof(T) == typeof(ushort))
            {
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.uint16_0.GetHashCode());
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.uint16_1.GetHashCode());
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.uint16_2.GetHashCode());
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.uint16_3.GetHashCode());
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.uint16_4.GetHashCode());
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.uint16_5.GetHashCode());
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.uint16_6.GetHashCode());
                return  CaoNC.System.Numerics.HashHelpers.Combine(num, register.uint16_7.GetHashCode());
            }
            if (typeof(T) == typeof(short))
            {
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.int16_0.GetHashCode());
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.int16_1.GetHashCode());
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.int16_2.GetHashCode());
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.int16_3.GetHashCode());
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.int16_4.GetHashCode());
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.int16_5.GetHashCode());
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.int16_6.GetHashCode());
                return  CaoNC.System.Numerics.HashHelpers.Combine(num, register.int16_7.GetHashCode());
            }
            if (typeof(T) == typeof(uint))
            {
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.uint32_0.GetHashCode());
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.uint32_1.GetHashCode());
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.uint32_2.GetHashCode());
                return  CaoNC.System.Numerics.HashHelpers.Combine(num, register.uint32_3.GetHashCode());
            }
            if (typeof(T) == typeof(int))
            {
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.int32_0.GetHashCode());
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.int32_1.GetHashCode());
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.int32_2.GetHashCode());
                return  CaoNC.System.Numerics.HashHelpers.Combine(num, register.int32_3.GetHashCode());
            }
            if (typeof(T) == typeof(ulong))
            {
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.uint64_0.GetHashCode());
                return  CaoNC.System.Numerics.HashHelpers.Combine(num, register.uint64_1.GetHashCode());
            }
            if (typeof(T) == typeof(long))
            {
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.int64_0.GetHashCode());
                return  CaoNC.System.Numerics.HashHelpers.Combine(num, register.int64_1.GetHashCode());
            }
            if (typeof(T) == typeof(float))
            {
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.single_0.GetHashCode());
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.single_1.GetHashCode());
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.single_2.GetHashCode());
                return  CaoNC.System.Numerics.HashHelpers.Combine(num, register.single_3.GetHashCode());
            }
            if (typeof(T) == typeof(double))
            {
                num =  CaoNC.System.Numerics.HashHelpers.Combine(num, register.double_0.GetHashCode());
                return  CaoNC.System.Numerics.HashHelpers.Combine(num, register.double_1.GetHashCode());
            }
            throw new NotSupportedException(SR.Arg_TypeNotSupported);
        }
        ...
        public unsafe static Vector<T> operator /(Vector<T> left, Vector<T> right)
        {
            ...
            if (typeof(T) == typeof(byte))
            {
                result.register.byte_0 = (byte)((int)left.register.byte_0 / (int)right.register.byte_0);
                result.register.byte_1 = (byte)((int)left.register.byte_1 / (int)right.register.byte_1);
                result.register.byte_2 = (byte)((int)left.register.byte_2 / (int)right.register.byte_2);
                result.register.byte_3 = (byte)((int)left.register.byte_3 / (int)right.register.byte_3);
                result.register.byte_4 = (byte)((int)left.register.byte_4 / (int)right.register.byte_4);
                result.register.byte_5 = (byte)((int)left.register.byte_5 / (int)right.register.byte_5);
                result.register.byte_6 = (byte)((int)left.register.byte_6 / (int)right.register.byte_6);
                result.register.byte_7 = (byte)((int)left.register.byte_7 / (int)right.register.byte_7);
                result.register.byte_8 = (byte)((int)left.register.byte_8 / (int)right.register.byte_8);
                result.register.byte_9 = (byte)((int)left.register.byte_9 / (int)right.register.byte_9);
                result.register.byte_10 = (byte)((int)left.register.byte_10 / (int)right.register.byte_10);
                result.register.byte_11 = (byte)((int)left.register.byte_11 / (int)right.register.byte_11);
                result.register.byte_12 = (byte)((int)left.register.byte_12 / (int)right.register.byte_12);
                result.register.byte_13 = (byte)((int)left.register.byte_13 / (int)right.register.byte_13);
                result.register.byte_14 = (byte)((int)left.register.byte_14 / (int)right.register.byte_14);
                result.register.byte_15 = (byte)((int)left.register.byte_15 / (int)right.register.byte_15);
            }
            else if (typeof(T) == typeof(sbyte))
            {
                result.register.sbyte_0 = (sbyte)(left.register.sbyte_0 / right.register.sbyte_0);
            ...
            {
                result.register.uint16_0 = (ushort)((int)left.register.uint16_0 / (int)right.register.uint16_0);
                result.register.uint16_1 = (ushort)((int)left.register.uint16_1 / (int)right.register.uint16_1);
                result.register.uint16_2 = (ushort)((int)left.register.uint16_2 / (int)right.register.uint16_2);
                result.register.uint16_3 = (ushort)((int)left.register.uint16_3 / (int)right.register.uint16_3);
                result.register.uint16_4 = (ushort)((int)left.register.uint16_4 / (int)right.register.uint16_4);
                result.register.uint16_5 = (ushort)((int)left.register.uint16_5 / (int)right.register.uint16_5);
                result.register.uint16_6 = (ushort)((int)left.register.uint16_6 / (int)right.register.uint16_6);
                result.register.uint16_7 = (ushort)((int)left.register.uint16_7 / (int)right.register.uint16_7);
            }
            else if (typeof(T) == typeof(short))
            {
                result.register.int16_0 = (short)(left.register.int16_0 / right.register.int16_0);
        ...
        internal static T DotProduct(Vector<T> left, Vector<T> right)
        {
            ...
            {
                byte b = 0;
                b = (byte)(b + (byte)(left.register.byte_0 * right.register.byte_0));
                b = (byte)(b + (byte)(left.register.byte_1 * right.register.byte_1));
                b = (byte)(b + (byte)(left.register.byte_2 * right.register.byte_2));
                b = (byte)(b + (byte)(left.register.byte_3 * right.register.byte_3));
                b = (byte)(b + (byte)(left.register.byte_4 * right.register.byte_4));
                b = (byte)(b + (byte)(left.register.byte_5 * right.register.byte_5));
                b = (byte)(b + (byte)(left.register.byte_6 * right.register.byte_6));
                b = (byte)(b + (byte)(left.register.byte_7 * right.register.byte_7));
                b = (byte)(b + (byte)(left.register.byte_8 * right.register.byte_8));
                b = (byte)(b + (byte)(left.register.byte_9 * right.register.byte_9));
                b = (byte)(b + (byte)(left.register.byte_10 * right.register.byte_10));
                b = (byte)(b + (byte)(left.register.byte_11 * right.register.byte_11));
                b = (byte)(b + (byte)(left.register.byte_12 * right.register.byte_12));
                b = (byte)(b + (byte)(left.register.byte_13 * right.register.byte_13));
                b = (byte)(b + (byte)(left.register.byte_14 * right.register.byte_14));
                b = (byte)(b + (byte)(left.register.byte_15 * right.register.byte_15));
                return (T)(object)b;
            }
            if (typeof(T) == typeof(sbyte))
            {
                sbyte b2 = 0;
                b2 = (sbyte)(b2 + (sbyte)(left.register.sbyte_0 * right.register.sbyte_0));
                b2 = (sbyte)(b2 + (sbyte)(left.register.sbyte_1 * right.register.sbyte_1));
                b2 = (sbyte)(b2 + (sbyte)(left.register.sbyte_2 * right.register.sbyte_2));
                b2 = (sbyte)(b2 + (sbyte)(left.register.sbyte_3 * right.register.sbyte_3));
                b2 = (sbyte)(b2 + (sbyte)(left.register.sbyte_4 * right.register.sbyte_4));
                b2 = (sbyte)(b2 + (sbyte)(left.register.sbyte_5 * right.register.sbyte_5));
                b2 = (sbyte)(b2 + (sbyte)(left.register.sbyte_6 * right.register.sbyte_6));
                b2 = (sbyte)(b2 + (sbyte)(left.register.sbyte_7 * right.register.sbyte_7));
                b2 = (sbyte)(b2 + (sbyte)(left.register.sbyte_8 * right.register.sbyte_8));
                b2 = (sbyte)(b2 + (sbyte)(left.register.sbyte_9 * right.register.sbyte_9));
                b2 = (sbyte)(b2 + (sbyte)(left.register.sbyte_10 * right.register.sbyte_10));
                b2 = (sbyte)(b2 + (sbyte)(left.register.sbyte_11 * right.register.sbyte_11));
                b2 = (sbyte)(b2 + (sbyte)(left.register.sbyte_12 * right.register.sbyte_12));
                b2 = (sbyte)(b2 + (sbyte)(left.register.sbyte_13 * right.register.sbyte_13));
                b2 = (sbyte)(b2 + (sbyte)(left.register.sbyte_14 * right.register.sbyte_14));
                b2 = (sbyte)(b2 + (sbyte)(left.register.sbyte_15 * right.register.sbyte_15));
                return (T)(object)b2;
            }
            if (typeof(T) == typeof(ushort))
            {
                ushort num = 0;
                num = (ushort)(num + (ushort)(left.register.uint16_0 * right.register.uint16_0));
                num = (ushort)(num + (ushort)(left.register.uint16_1 * right.register.uint16_1));
                num = (ushort)(num + (ushort)(left.register.uint16_2 * right.register.uint16_2));
                num = (ushort)(num + (ushort)(left.register.uint16_3 * right.register.uint16_3));
                num = (ushort)(num + (ushort)(left.register.uint16_4 * right.register.uint16_4));
                num = (ushort)(num + (ushort)(left.register.uint16_5 * right.register.uint16_5));
                num = (ushort)(num + (ushort)(left.register.uint16_6 * right.register.uint16_6));
                num = (ushort)(num + (ushort)(left.register.uint16_7 * right.register.uint16_7));
                return (T)(object)num;
            }
            if (typeof(T) == typeof(short))
            {
                short num2 = 0;
                num2 = (short)(num2 + (short)(left.register.int16_0 * right.register.int16_0));
                num2 = (short)(num2 + (short)(left.register.int16_1 * right.register.int16_1));
                num2 = (short)(num2 + (short)(left.register.int16_2 * right.register.int16_2));
                num2 = (short)(num2 + (short)(left.register.int16_3 * right.register.int16_3));
                num2 = (short)(num2 + (short)(left.register.int16_4 * right.register.int16_4));
                num2 = (short)(num2 + (short)(left.register.int16_5 * right.register.int16_5));
                num2 = (short)(num2 + (short)(left.register.int16_6 * right.register.int16_6));
                num2 = (short)(num2 + (short)(left.register.int16_7 * right.register.int16_7));
        ...
        private static T ScalarDivide(T left, T right)
        {
            if (typeof(T) == typeof(byte))
            {
                return (T)(object)(byte)((int)(byte)(object)left / (int)(byte)(object)right);
            }
            if (typeof(T) == typeof(sbyte))
            {
                return (T)(object)(sbyte)((sbyte)(object)left / (sbyte)(object)right);
            ...
            if (typeof(T) == typeof(ushort))
            {
                return (T)(object)(ushort)((int)(ushort)(object)left / (int)(ushort)(object)right);
            }
            if (typeof(T) == typeof(short))
            {
                return (T)(object)(short)((short)(object)left / (short)(object)right);
