...
namespace CaoNC.System
{
    public static class AppContext
    {
        ...
        public static string BaseDirectory => ((string)AppDomain.CurrentDomain.GetData("APP_CONTEXT_BASE_DIRECTORY")) ?? 
        ...
        public static bool TryGetSwitch(string switchName, out bool isEnabled)
        {
            ...
            lock (s_switchMap)
            {
                if (s_switchMap.TryGetValue(switchName, out var value))
                {
                    ...
                    s_switchMap[switchName] = ((!isEnabled) ? SwitchValueState.HasFalseValue : SwitchValueState.HasTrueValue) | SwitchValueState.HasLookedForOverride;
                    return true;
                }
        ...
        public static void SetSwitch(string switchName, bool isEnabled)
        {
            ...
            SwitchValueState value = ((!isEnabled) ? SwitchValueState.HasFalseValue : SwitchValueState.HasTrueValue) | SwitchValueState.HasLookedForOverride;
            lock (s_switchMap)
            {
