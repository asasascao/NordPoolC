...
namespace CaoNC.System.Threading
{
    ...
    //        get
    //        {
    //            if ((_flags & Flags.IsPreAllocatedDefault) != 0)
    //            {
    //                return true;
    //            }
    //            return false;
    ...
    //        localValues = (mutableExecutionContext._localValues = ((localValues != null) ? localValues.Set(local, newValue, !needChangeNotifications) : AsyncLocalValueMap.Create(local, newValue, !needChangeNotifications)));
    ...
    //        }
    //        if ((options & CaptureOptions.OptimizeDefaultCase) != 0 && securityContext == null && hostExecutionContext == null && synchronizationContext == null && (logicalCallContext == null || !logicalCallContext.HasInfo) && asyncLocalValueMap == null && array == null)
    //        {
    //            return s_dummyDefaultEC;
    //        }
    //        ExecutionContext executionContext = new ExecutionContext();
